...
### Як запустити Jupyter Notebook аналізу

1. Активуйте віртуальне середовище вашого проекту.

2. Встановіть необхідні пакети (одноразово):
   - `pip install jupyter pandas seaborn vaderSentiment`

3. Запустіть Jupyter та виконайте всі клітинки зверху донизу (Run All).
   - воно автоматично візьме останній `chat_*.csv` з папки `test_results/`.
   - буде згенеровано один PNG‑звіт із графіками та підсумком безпечності:
     - `test_results/plots/notebook_viz_uk_latest.png`